...
# def rec_letter(first_name, last_name, rec_firstName, rec_lastName):
#     letter = f"""
...
#     My name is {first_name} {last_name}. I have served as a science teacher at Parktown High School for the past fifteen years and have had the privilege to serve as {rec_firstName} {rec_firstName}'s teacher for the past three. I have also been {rec_firstName}+'\’s 'advisor on the science academic team here at school. Due to his qualifications, I feel that rec_firstName would be an excellent addition to your school.

#     While he has been a student here, {rec_firstName} has always challenged himself academically, taking all of the AP courses that our school has to offer. He has been captain of the academic team for the past two years, showing strong leadership qualities and organizational skills. His superior written and verbal skills have far surpassed any student of his age.

#     {rec_firstName} would bring much to your school, both in and out of the classroom. If you have any questions regarding {rec_firstName}'s qualifications, please contact me at (123) 555-5555 or at {first_name}.{last_name}@email.com.
...
# rec_letter("Shannon", "Kroll", "Mark", "Dalrympl")
...
# def rec_letter(last_name, first_name, rec_lastName, rec_firstName):
#     letter = f"""
#     {first_name} {last_name}
#     1234 Park St
#     Anytown, Pennsylvania 12345
